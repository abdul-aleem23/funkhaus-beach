      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-open-sans text-xl text-gray-700 max-w-xl mx-auto">
            Partner with Berlin's premier beach volleyball destination. Let's create something amazing together.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <motion.button
              type="submit"
              className="font-open-sans w-full px-6 py-4 rounded-sm text-base font-semibold shadow-lg"
              style={{
